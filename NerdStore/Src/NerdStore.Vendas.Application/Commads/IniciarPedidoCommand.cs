...
namespace NerdStore.Vendas.Application.Commads
{
    public class IniciarPedidoCommand : Command
    {
        ...
        public IniciarPedidoCommand(Guid pedidoId, Guid clienteId, decimal total, string nomeCartao, string numeroCartao, string expericacaoCartao, string cvvCartao)
        {
            PedidoId = pedidoId;
            ClienteId = clienteId;
            Total = total;
            ...
            ExpiracaoCartao = expericacaoCartao;
            CvvCartao = cvvCartao;
        }
